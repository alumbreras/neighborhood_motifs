...
plot.forest <- function(gforest){
  # Plot the threads of a forum
  # Arguments:
  #   gforest: and igraph object
...
plot.forest.gephi <- function(df.posts){
  # Creates a gexf file that represents the graph of threes (forest) of a set of posts
  # extracted from a forum
  # Arguments:
  #   df.posts: dataframe with posts in rows and at least columns postid, parent, and date
...
plot.socioalnetwork.gephi <- function(df.posts){
  # Dynamic graph  
