...
Figure \ref{fig:census_orderbased} and \ref{fig:neighbourhoods_time} show the most frequent order-based and time-based neighbourhoods in the Podemos dataset. In Figure X we compare the census of the most frequent neighbourhoods in the Podemos and the Game of Thrones forums. 

% TODO: Explicar un poco los resultados y conclusiones del censo. Mostrar grafica de frecuencia de cada motif o cumsum, para ilustrar como de distribuido esta el censo.
